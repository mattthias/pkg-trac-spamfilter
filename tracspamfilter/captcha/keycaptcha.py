...
class KeycaptchaCaptcha(Component):
    ...
    def generate_captcha(self, req):
        ...
        sign1 = md5.new(session_id + req.remote_addr + self.private_key).hexdigest()
        sign2 = md5.new(session_id + self.private_key).hexdigest()
    ...
    def verify_captcha(self, req):
        ...
        try:
            ...
            s = md5.new("accept"+val[1]+self.private_key+val[2]).hexdigest()
